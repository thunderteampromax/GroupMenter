...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Disaster level of this person is 'Ultra'."
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis user is member of 'Thunder GoTechnology'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="Https://t.me/thundergohelpbot">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/thunderprojectsupdates/25)
"""
